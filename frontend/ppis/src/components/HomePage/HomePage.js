      ...
      <div className="HomePage">
        ...
        <Container>
          ...
          <Row>
              ...
              <Col sm>
                  <Usluga name="Izrada web stranice" cijena="35.00" kratkiopis={this.state.opiskratki1} url="/usluga1"/>
              </Col>

              <Col sm>
                  <Usluga name="Upravljanje rezervacijama" cijena="50.00" kratkiopis={this.state.opiskratki2} url="/usluga2"/>
              </Col>
          ...
          <Row>
              ...
              <Col sm>
                <Usluga name="Upravljanje uposlenicima" kratkiopis={this.state.opiskratki3} cijena="50.00" url="/usluga3"/>
              </Col>

              <Col sm>
              <Usluga name="Upravljanje poslovanjem" kratkiopis={this.state.opiskratki4} cijena="50.00" url="/usluga4"/>
              </Col>
